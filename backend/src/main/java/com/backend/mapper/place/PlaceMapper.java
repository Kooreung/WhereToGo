...
public interface PlaceMapper {
    @Insert("""
            INSERT INTO place (placeName, placeUrl, address, category, latitude, longitude, postid, addressCountry, addressCity, placeIndex)
            VALUES (#{placeName}, #{placeUrl}, #{address}, #{category}, #{latitude}, #{longitude}, #{postId}, #{addressCountry}, #{addressCity}, #{placeIndex})
            """)
